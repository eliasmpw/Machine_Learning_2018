...
\hline
\textbf{Model}                                                              & \textbf{RMSE} & \textbf{Hyper Param}                                      & \textbf{Comment} \\ \hline
\begin{tabular}[c]{@{}l@{}}Least Squeares\\   GD\end{tabular}               & 8             & \begin{tabular}[c]{@{}l@{}}degree=\\ lambda=\end{tabular} & comment          \\ \hline
\begin{tabular}[c]{@{}l@{}}Least Squeares\\   SGD\end{tabular}              & 8             & \begin{tabular}[c]{@{}l@{}}degree=\\ lambda=\end{tabular} & comment          \\ \hline
Least Squeares                                                              & 8             & \begin{tabular}[c]{@{}l@{}}degree=\\ lambda=\end{tabular} & comment          \\ \hline
\begin{tabular}[c]{@{}l@{}}Ridge\\   Regression\end{tabular}                & 8             & \begin{tabular}[c]{@{}l@{}}degree=\\ lambda=\end{tabular} & comment          \\ \hline
\begin{tabular}[c]{@{}l@{}}Logistic\\   Regression\end{tabular}             & 8             & \begin{tabular}[c]{@{}l@{}}degree=\\ lambda=\end{tabular} & comment          \\ \hline
\begin{tabular}[c]{@{}l@{}}Regularized\\   Logistic Regression\end{tabular} & 8             & \begin{tabular}[c]{@{}l@{}}degree=\\ lambda=\end{tabular} & comment          \\ \hline
\end{tabular}
\end{table}
